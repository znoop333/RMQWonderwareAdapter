                                ...
                                else if (null != scanr)
                                {
                                    switch (sElementName)
                                    {
                                        case Scanner.TAG_OPCODE:
                                            ...
                                            if (!(ScannerConstants.RSM_ATTR_GET == nOpCode))
                                            {
                                                return;
                                            }
                                            break;
                                        ...
                                        case Scanner.TAG_ATTRIBUTE:
                                            if (ScannerConstants.RSM_ATTR_GETALL == nOpCode)
                                            {
                                ...
                                else if (null != scanr)
                                {
                                    switch (sElementName)
                                    {
                                        case Scanner.TAG_OPCODE:
                                            nOpCode = Int32.Parse(sElmValue);
                                            if (!(ScannerConstants.RSM_ATTR_GETALL == nOpCode ||
                                                    ScannerConstants.RSM_ATTR_GET == nOpCode ||
                                                    ScannerConstants.RSM_ATTR_GETNEXT == nOpCode))
                                            {
                                                return;
                                            }
                                            break;
